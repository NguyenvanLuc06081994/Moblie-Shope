			...
			<div class="row cart_items_row">
				<div class="col">
					...
					<div class="cart_item d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start">
						...
						<!-- Price -->
						<div class="cart_item_price">{{number_format($product['productInfo']->price)}} VND</div>
						<!-- Quantity -->
						...
						<!-- Total -->
						<div class="cart_item_total"><span>{{number_format($product['productInfo']->price * $product['quantity'])}} VND</span>
                            <a href="{{route('carts.deleteProduct',$product['productInfo']->id)}}" class="delete-product-cart">delete</a>
						...
						<div class="cart_total_container">
							<ul>
								<li class="d-flex flex-row align-items-center justify-content-start">
									...
									<div class="cart_total_value ml-auto">{{\Illuminate\Support\Facades\Session::get('Cart') ? number_format(\Illuminate\Support\Facades\Session::get('Cart')->totalPrice) : 0}} VND</div>
								</li>
								<li class="d-flex flex-row align-items-center justify-content-start">
