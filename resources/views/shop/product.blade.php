			...
			<div class="row details_row">
				...
				<div class="col-lg-6">
					<div class="details_image">
						<div class="details_image_large"><img src="{{asset('backEnd/storage').'/'.$product->image}}" alt=""><div class="product_extra product_new"><a href="categories.html">New</a></div></div>
				...
				<div class="col-lg-6">
					<div class="details_content">
						...
						<div class="details_price">{{number_format($product->price)}} VND</div>
						...
						<div class="product_quantity_container">
							...
							<div class="button cart_button"><a href="{{route('carts.addToCart',$product->id)}}">Add to cart</a></div>
						</div>
