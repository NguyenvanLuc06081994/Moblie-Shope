                    ...
                    <li class="page_menu_item has-children menu_mm">
                        ...
                        <ul class="page_menu_selection menu_mm">
                            ...
                            <li class="page_menu_item menu_mm"><a href="product.html">Product<i
                                        class="fa fa-angle-down"></i></a></li>
                            <li class="page_menu_item menu_mm"><a href="{{route('carts.list')}}">List Cart<i class="fa fa-angle-down"></i></a>
                            </li>
                            <li class="page_menu_item menu_mm"><a href="checkout.html">Checkout<i
                                        class="fa fa-angle-down"></i></a></li>
                            <li class="page_menu_item menu_mm"><a href="contact.html">Contact With Us<i
                                        class="fa fa-angle-down"></i></a></li>
                        </ul>
                    </li>
                    <li class="page_menu_item has-children menu_mm">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="home_slider_content" data-animation-in="fadeIn"
                                        ...
                                        <div class="home_slider_title">CodeGym Shop</div>
