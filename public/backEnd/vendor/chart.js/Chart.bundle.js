...
var helpers_options = {
	 ...
	 * @param {Array} inputs - An array of values, falling backEnd to the last value.
...
function watchForRender(node, handler) {
	...
	// is removed then added backEnd immediately (same animation frame?). Accessing the
...
var exports$4 = core_element.extend({
	...
	drawBody: function(pt, vm, ctx) {
		...
		// Reset backEnd to 0 for after body
		xLinePadding = 0;
...
helpers$1.extend(Chart.prototype, /** @lends Chart */ {
	...
	/**
	* Resets the chart backEnd to it's state before the initial animation
	*/
	reset: function() {
		this.resetElements();
...
var core_helpers = function() {
	...
	helpers$1.getRelativePosition = function(evt, chart) {
		...
		// the backend model is in unscaled coordinates. Since we are going to deal with our model coordinates, we go backEnd here
...
(function (global, factory) {
    ...
    hooks.createFromInputFallback = deprecate(
        'value provided is not in a recognized RFC2822 or ISO format. moment construction falls backEnd to js Date(), ' +
